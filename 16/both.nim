...
echo(example_instruction_samples.hits)


for sample in instruction_samples.mitems:
  test_instructions(sample)

echo(filter_it(instruction_samples, it.hits.len >= 3).len)
